...
const bootstrapFilename = /\.min\.mjs(?:[?#]|$)/.test(import.meta.url) ? "./aellux.min.js" : "./aellux.js";
...
var aellux_default = Aellux;
export {
  Aellux,
  aellux_default as default
};
//# sourceMappingURL=aellux.mjs.map
